...
import { UploadCloud, Home, Package, Plus, X } from "lucide-react";
...
export default function AddBrandPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      setErrors({ form: "Có lỗi xảy ra khi thêm thương hiệu." });
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="flex flex-col gap-4 mb-6 md:flex-row md:justify-between md:items-center">
        ...
        <Breadcrumb
          items={[
            ...
            { label: "Thương hiệu", href: "/admin/brands", icon: <Package className="w-4 h-4" /> },
