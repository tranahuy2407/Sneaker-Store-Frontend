      ...
      <div className="flex flex-col gap-4 mb-6 lg:flex-row lg:justify-between lg:items-center">
        <div>
          ...
          <p className="text-sm text-gray-500 sm:text-base">
            Quản lý tất cả danh mục hiển thị trong hệ thống
          </p>
        </div>
        ...
        <Breadcrumb
          items={[
            ...
            { label: "Danh mục", icon: <Folder className="w-4 h-4" /> },
          ]}
        />
      </div>
  ...
  {/* Bộ lọc */}
          ...
          <table className="w-full text-sm text-left text-gray-700">
            ...
            <tbody>
              {loading ? (
                ...
                categories.map((cat) => (
                  <tr key={cat.id} className="transition border-b hover:bg-gray-50">
     ...
     <Pagination
      ...
      <WarningModal
        open={warningOpen}
        title="Xác nhận xóa"
        message={`Bạn có chắc muốn xóa danh mục "${categoryToDelete?.name}"? Hành động này không thể hoàn tác.`}
